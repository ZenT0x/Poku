...
config = jsonclass("config.json") # on crée un objet jsonclass pour le fichier config.json
config.read_config() # on lit le fichier config.json

minecraft = jsonclass("minecraft_servers.json") # on crée un objet jsonclass pour le fichier minecraft_servers.json
